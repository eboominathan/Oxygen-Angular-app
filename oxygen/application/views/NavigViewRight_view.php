...
<div modal="searchDialog"  options="opts">
		...
		<div class="controls">
		  <select ng-options="s.NavigationId as s.NavName for s in NavigationsList"   ng-model="search.Navigations" ></select>		  
		</div></div>
<div class="control-group" ><label class="control-label" for="Roles">Roles</label>
		<div class="controls">
		  <select ng-options="s.RoleId as s.RoleName for s in RolesList"   ng-model="search.Roles" ></select>		  
		</div></div>
<div class="control-group" ><label class="control-label" for="Users">Users</label>
		<div class="controls">
		  <select ng-options="s.UserId as s.UserName for s in UsersList"   ng-model="search.Users" ></select>		  
		</div></div>
